...
def autoscale(ax=None, axis='y', margin=0.1):
    """Autoscale the given axis to match manually set bounds on the other axis.
    ...
    for artist in ax.collections + ax.lines:
        ...
        low, high = _autoscale__calculate_new_limit(fixed, dependent, lim)
...
def _autoscale__calculate_new_limit(fixed, dependent, limit):
